...
INSERT INTO "projection-room"("room-name", "seat-quantity", "cinema_id") VALUES
("salle 1", 456, 1),
("Salle 2", 301, 1),
("Salle 3", 254, 1),
("Salle 1", 250, 2),
...
INSERT INTO "session"("movie_id", "projection-room_id", "date_time") VALUES
...
INSERT INTO "booking"("client_id", "session_id", "price_id", "nb-seat", "payment_id") VALUES
(1, 1, 1, 2, 1),
(1, 1, 2, 1, 1),
(1, 1, 3, 3, 1),
(2, 5, 1, 5, 3)
